const Logo = ({ className }: { className?: string }) => {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="96" height="96" fill="none" viewBox="0 0 96 96">
      ...
      <path fill="#fff" d="M59.983 46.607c-.208 8.14-6.698 14.667-14.776 15.152 8.229.26 15.19-5.613 15.703-13.4.042-.639-.289-1.224-.926-1.752z"></path>
      ...
      <g clipPath="url(#clip0_1_77)">
        <path fill="#5282FF" d="M78.247 14.537l-1.305 3.478-3.477 1.304 3.477 1.304 1.305 3.478 1.304-3.478 3.477-1.304-3.477-1.304-1.304-3.478z"></path>
      </g>
      <g clipPath="url(#clip1_1_77)">
        <path fill="#5282FF" d="M14.777 65.834l-1.304 3.478-3.478 1.304 3.478 1.305 1.304 3.477 1.304-3.477 3.478-1.305-3.478-1.304-1.304-3.478z"></path>
      </g>
      <defs>
        <filter id="filter0_d_1_77" width="82.6" height="82.6" x="4.965" y="6.965" colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse">
