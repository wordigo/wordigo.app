  ...
  return (
    ...
    >
      ...
      <path
        ...
        d="M65.205 47.692c0 9.78-9.148 17.708-20.432 17.708-11.284 0-20.432-7.928-20.432-17.708 0-3.39 9.148-4.898 20.432-4.898 11.284 0 20.432 1.507 20.432 4.898z"
      ></path>
      <path
        fill="#fff"
        d="M59.983 46.607c-.208 8.14-6.698 14.667-14.776 15.152 8.229.26 15.19-5.613 15.703-13.4.042-.639-.289-1.224-.926-1.752z"
      ></path>
      ...
      <g clipPath="url(#clip0_1_77)">
        <path
          fill="#5282FF"
          d="M78.247 14.537l-1.305 3.478-3.477 1.304 3.477 1.304 1.305 3.478 1.304-3.478 3.477-1.304-3.477-1.304-1.304-3.478z"
        ></path>
      </g>
      <g clipPath="url(#clip1_1_77)">
        <path
          fill="#5282FF"
          d="M14.777 65.834l-1.304 3.478-3.478 1.304 3.478 1.305 1.304 3.477 1.304-3.477 3.478-1.305-3.478-1.304-1.304-3.478z"
        ></path>
      </g>
      <defs>
        <filter
        ...
        <clipPath id="clip0_1_77">
          <path
            fill="#fff"
            d="M0 0H10.433V10.433H0z"
            transform="translate(73.03 14.102)"
          ></path>
        </clipPath>
