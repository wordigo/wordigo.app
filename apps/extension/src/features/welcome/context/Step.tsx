...
export const StepsProvider: React.FC<PropsWithChildren> = ({ children }) => {
...
export const useSteps = () => {
  ...
  const { prev, next, jump, isFirst, isLast, hasPrev, hasNext, progress, size: total, current } = stepsContext
  return {
    prev,
    next,
    jump,
