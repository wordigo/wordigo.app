    ...
    <Animation>
      <section className="max-w-screen-8xl w-full m-auto">
        <div className="flex flex-col items-center justify-center">
          <h1 className="text-3xl opacity-80 font-bold tracking-tight">{t("about.teams")}</h1>
          <div className="gap-6 justify-center flex-wrap items-center py-8 mx-auto max-w-screen-2xl flex lg:py-16 lg:px-6">
...
TeamSection.Item = ({ github, linkedin, name, src, title, twitter }: ITeam) => {
  return (
    <Animation>
      <div className="w-[280px] h-[300px] px-8 py-5 rounded-xl dark:bg-[#141420] bg-[#F3F4FE] border-[#e9eafe]  text-light_text border dark:text-white dark:border-[rgb(33,32,44)] shadow-lg dark:shadow-black">
        <span className={cn("flex items-center gap-3 flex-col")}>
          ...
          <h1>{name}</h1>
          <p className="text-center truncate">{title}</p>
        </span>
