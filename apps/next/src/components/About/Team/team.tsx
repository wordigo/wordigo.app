...
const TeamSection = () => {
  ...
  return (
    <section className="w-full flex flex-col items-center px-20 py-24">
      <span className="px-32 w-full flex flex-col">
        <h2 className="text-4xl font-semibold text-center">{t("about.team.heading")}</h2>
        <p className="text-xl text-muted-foreground mt-5 text-center">{t("about.team.subheading")}</p>
      </span>
      <div className="mt-16 w-full grid grid-cols-4 grid-rows-2 gap-x-8 gap-y-16">
