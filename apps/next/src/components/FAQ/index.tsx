...
import FAQ, { type Question } from "@/components/Home/FAQSection/faq.constant";

const FAQSection = () => {
    const { t } = useTranslation();

    return (
        <section className="px-20 py-24 flex flex-col items-center max-lg:px-9 max-md:px-0 max-lg:py-12">
            ...
            <div className="mt-16 grid grid-cols-3 gap-x-8 gap-y-16 max-lg:grid-cols-2 max-md:grid-cols-1 max-lg:mt-20 max-md:mx-4">
                {FAQ.map((item, index) => (
