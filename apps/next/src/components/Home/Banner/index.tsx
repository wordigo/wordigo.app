...
export default function FeatureBanner() {
  ...
  return (
    <section className="w-full flex flex-col items-center px-20 py-24 max-md:px-4 max-lg:py-16">
      ...
      <h2 className="mt-4 text-4xl font-semibold max-lg:text-3xl">{t("feature_mockup.heading")}</h2>
      <p className="text-xl text-muted-foreground mt-5 max-lg:text-lg max-lg:mt-4">{t("feature_mockup.description")}</p>
