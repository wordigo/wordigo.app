...
const FAQSection = () => {
  ...
  return (
    <section className="px-20 py-24 flex flex-col items-center max-md:px-4">
      ...
      <div className="mt-16 grid grid-cols-3 grid-rows-2 gap-x-8 gap-y-16 max-lg:grid-cols-2 max-md:grid-cols-1 max-lg:mt-12">
        {FAQ.map((item, index) => (
