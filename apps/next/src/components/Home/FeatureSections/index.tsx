...
FeatureSection.Item = ({
  ...
  const classes = cn("px-8 w-full max-xl:flex-col max-xl:items-center max-xl:justify-center max-md:px-4", positionLeft ? "flex xl:flex-row-reverse" : "flex");
  ...
  return (
    <section className={classes}>
      <div className="flex flex-col justify-center">
        ...
        <p className="text-lg text-muted-foreground mt-4 max-lg:text-base">{description}</p>
      ...
      <div className={cn("lg:min-w-[35rem] h-[25rem] lg:w-[40rem] lg:mt-12 lg:h-[28rem] md:w-[30rem] md:h-[24rem] max-md:w-[340px] max-md:h-[240px] max-lg:mt-12 relative", positionLeft ? "xl:mr-24 max-xl:mr-0" : "xl:ml-24 max-xl:ml-0")}>
