...
export default function Footer() {
  ...
  return (
    <footer className="relative container" aria-labelledby="footer" id="footer">
      <section className="xl:justify-between xl:flex dark:border-white/5 border-t lg:pt-24 max-lg:pt-12 border-black/30 pb-8">
