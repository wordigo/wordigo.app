...
export default function BurgerMenu() {
  return (
    <div className="col-span-1 flex flex-col fixed justify-between left-0 py-8 top-0 z-50 text-light_text dark:text-white dark:bg-DarkBackground bg-LightBackground g-red-500 px-5 min-w-[280px] max-w-[280px] rounded-r-2xl border-r-[#EAECF0] shadow-md shadow-[rgba(16, 24, 40, 1)] h-screen">
      <span>
