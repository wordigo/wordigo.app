const GradientSvg = () => {
  return (
    <svg
      className="opacity-[0.45] dark:opacity-[0.15] dark:!bg-none"
      width="100%"
      height="100%"
    ...
    >
      <mask
        ...
        height="820"
      >
        <rect width="1440" height="820" fill="url(#paint0_radial_343_6630)" />
      </mask>
      ...
      <defs>
        ...
        >
          ...
          <stop offset="0.991144" stop-color="white" stopOpacity="0" />
        </radialGradient>
      </defs>
    </svg>
  );
