...
const NavProfile = () => {
  ...
  return (
    <main className="justify-between items-center relative">
      ...
      <button
        className="hidden md:block z-40 cursor-pointer border-none hover:bg-none text-gray-400 right-0 hover:!text-red-500 absolute top-2 p-2 bottom-0 w-fit h-fit"
